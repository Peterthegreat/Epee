#include "epee.c"
#define COMANDA_0 
#define COMANDA_1 "omxplayer music/1.mp3"
#define COMANDA_2 "omxplayer music/2.mp3"
#define COMANDA_3 "omxplayer music/3.mp3"
#define COMANDA_4 "omxplayer music/4.mp3"
